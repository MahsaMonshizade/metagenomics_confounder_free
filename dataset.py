...
class MicroDataset(Dataset): 
	def __init__(self, data, metadata, species_dict, output): 
		"""
		...
		if os.path.exists(embedding_file_path):
			...
			self.process_data(data, metadata,species_dict, output)
	...
	def process_data(self, data, metadata, species_dict, output):
		"""
