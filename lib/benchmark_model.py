...
def train_model(model, epochs, relative_abundance, metadata, batch_size=64, lr_r=0.001, lr_g=0.001, lr_c=0.005):
    ...
    for fold, (train_index, val_index) in enumerate(skf.split(relative_abundance, metadata['disease'])):
        ...
        plot_losses(c_losses, dcs0_age, dcs1_age, mis0_age, mis1_age, dcs0_bmi, dcs1_bmi, mis0_bmi, mis1_bmi, train_disease_accs, val_disease_accs, train_disease_aucs, val_disease_aucs, train_disease_f1s, val_disease_f1s, fold)
...
def plot_losses(c_losses, dcs0_age, dcs1_age, mis0_age, mis1_age, dcs0_bmi, dcs1_bmi, mis0_bmi, mis1_bmi, train_disease_accs, val_disease_accs, train_disease_aucs, val_disease_aucs, train_disease_f1s, val_disease_f1s, fold):
