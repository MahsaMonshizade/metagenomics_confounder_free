...
def main():
    os.makedirs("Results/FCNN_encoder_confounder_free_finetune_plots", exist_ok=True)
    ...
    for fold, (train_index, val_index) in enumerate(skf.split(X, y_all)):
        ...
        torch.save(model.state_dict(), f"Results/FCNN_encoder_confounder_free_finetune_plots/trained_model_fold{fold+1}.pth")
        pd.Series(feature_columns).to_csv("Results/FCNN_encoder_confounder_free_finetune_plots/feature_columns.csv", index=False)
        ...
        plot_confusion_matrix(Results["train"]["confusion_matrix"][-1],
                              ...
                              save_path=f"Results/FCNN_encoder_confounder_free_finetune_plots/fold_{fold+1}_train_conf_matrix.png",
                              class_names=["Class 0", "Class 1"])
        plot_confusion_matrix(Results["val"]["confusion_matrix"][-1],
                              title=f"Validation Confusion Matrix - Fold {fold+1}",
                              save_path=f"Results/FCNN_encoder_confounder_free_finetune_plots/fold_{fold+1}_val_conf_matrix.png",
                              class_names=["Class 0", "Class 1"])
        plot_confusion_matrix(Results["test"]["confusion_matrix"][-1],
                              title=f"Test Confusion Matrix - Fold {fold+1}",
                              save_path=f"Results/FCNN_encoder_confounder_free_finetune_plots/fold_{fold+1}_test_conf_matrix.png",
                              class_names=["Class 0", "Class 1"])
        ...
        plt.tight_layout()
        plt.savefig(f"Results/FCNN_encoder_confounder_free_finetune_plots/fold_{fold+1}_metrics.png")
        plt.close()
    ...
    plt.tight_layout()
    plt.savefig("Results/FCNN_encoder_confounder_free_finetune_plots/average_metrics.png")
    plt.close()

    # Plot aggregated confusion matrices.
    plot_confusion_matrix(train_conf_matrix_avg[-1],
                          title="Average Train Confusion Matrix",
                          save_path="Results/FCNN_encoder_confounder_free_finetune_plots/average_train_conf_matrix.png",
                          class_names=["Class 0", "Class 1"])
    plot_confusion_matrix(val_conf_matrix_avg[-1],
                          title="Average Validation Confusion Matrix",
                          save_path="Results/FCNN_encoder_confounder_free_finetune_plots/average_val_conf_matrix.png",
                          class_names=["Class 0", "Class 1"])
    plot_confusion_matrix(test_conf_matrix_avg[-1],
                          title="Average Test Confusion Matrix",
                          save_path="Results/FCNN_encoder_confounder_free_finetune_plots/average_test_conf_matrix.png",
                          class_names=["Class 0", "Class 1"])
    ...
    metrics_df.to_csv("Results/FCNN_encoder_confounder_free_finetune_plots/metrics_summary.csv", index=False)
    print("Metrics summary saved to 'Results/FCNN_encoder_confounder_free_finetune_plots/metrics_summary.csv'.")
