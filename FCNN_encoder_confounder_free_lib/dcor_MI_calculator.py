...
# Features and labels
feature_columns = [col for col in merged_test_data.columns if col not in pd.read_csv(data_cfg["test_metadata_path"]).columns and col != "SampleID"]
...
for fold in range(1, n_folds + 1):
    ...
    model_path = f"Results/FCNN_encoder_confounder_free_plots/trained_model_fold{fold}.pth"
