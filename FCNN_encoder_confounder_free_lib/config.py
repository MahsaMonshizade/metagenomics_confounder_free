config = {
    ...
    "training": {
        ...
        "encoder_lr": 0,                 # For encoder (e.g., for distillation phase)
        "classifier_lr": 0,              # For confounder classifier (e.g., 'drug' branch)
        "weight_decay": 1e-4,
    ...
    "tuning": {
        ...
        "learning_rate": [1e-5, 2e-5, 5e-5,
                          ...
                          1e-2, 2e-2, 5e-2,
                          1e-1],
        "encoder_lr": [1e-5, 2e-5, 5e-5,
                       1e-4, 2e-4, 5e-4,
                       1e-3, 2e-3, 5e-3,
                       1e-2, 2e-2, 5e-2,
                       1e-1],
        "classifier_lr": [1e-5, 2e-5, 5e-5,
                          1e-4, 2e-4, 5e-4,
                          1e-3, 2e-3, 5e-3,
                          1e-2, 2e-2, 5e-2,
                          1e-1],
