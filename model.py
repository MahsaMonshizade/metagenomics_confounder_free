...
class gender_classifier(nn.Module):
    def __init__(self, latent_dim=256):
        ...
        self.fc3 = nn.Linear(latent_dim // 4, latent_dim // 8)
        self.fc4 = nn.Linear(latent_dim // 8, latent_dim // 16)
        self.fc5 = nn.Linear(latent_dim // 16, 1)
...
class feature_encoder(nn.Module):
    def __init__(self, ft_bank_baseline=256, species_dim=species_dim):
